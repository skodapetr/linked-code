...
Yet those artefacts are often not owned by the developers, although they may be tasked to keep them up to date.
...
The source of truth is the code, the ultimate definition of architecture, data model and behaviour. 
...
For example, a class model may define a data model for an application, until there is code with a domain model implemented in a programing language of choice. 
